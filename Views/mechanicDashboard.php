...
<head>
    ...
    <title>AUTODOC BREAKDOWN ASSISTANCE | Mechanic Dashboard</title>
        ...
        <div class="admin-sidebar" id="adminSidebar">
            <div class="admin-profile">
                <div class="admin-avatar">
                    <img src="../img/avatar.png" alt="Mechanic" onerror="this.src='https://ui-avatars.com/api/?name=Vijay+Kumar&background=ff6b6b&color=fff'">
                </div>
                <h5 class="admin-name">Mechanic</h5>
                <p class="admin-email">a@gmail.com</p>  
            </div>
